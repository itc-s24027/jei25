...
class Drink2 { //飲料水の名前と価格を管理クラス
    private String name;
    private int price;
    Drink2(String name, int price) { //名前と価格の文字列を返す
        this.name = name;
        this.price = price;
    }
...
class VendingMachine2 { //自動販売機をシミュレートするクラス
    private Drink2[] drinks; //販売する飲料水一覧
    private int cash = 0;
    private int[] coins = {500, 100, 50, 10};
    VendingMachine2(Drink2[] drinks) { //コンストラクタ
        this.drinks = drinks;
    }
    ...
    public void execCom(String[] commands) { //引数のコマンドを解釈
